...
write_bank_register : process (clk,RegWrite,reset)
	begin
		if reset = '1' then
			bank_register(0) <= "0000000000000000"; -- constant zero
			bank_register(1) <= "0000000000000100"; 
			bank_register(2) <= "0000000000000010"; 
			bank_register(3) <= "0000000000000000"; 
			bank_register(4) <= "0000000000000000"; 
			bank_register(5) <= "0000000000000000"; 
			bank_register(6) <= "0000000000000000"; 
			bank_register(7) <= "0000000000000000";
